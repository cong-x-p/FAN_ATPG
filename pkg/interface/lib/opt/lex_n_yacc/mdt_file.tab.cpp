...
#line 106 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
...
#line 177 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
...
#line 57 "src/mdt_file.y"
      { mdt = (MdtFile *)(param); }
#line 1400 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;

  case 8:
#line 74 "src/mdt_file.y"
           { mdt->addModel((yyvsp[0].ychar)); }
#line 1406 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;

  case 9:
#line 79 "src/mdt_file.y"
           { mdt->addPorts((yyvsp[0].ynames)->head); }
#line 1412 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1432 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;

  case 15:
#line 113 "src/mdt_file.y"
             { (yyval.yportType) = MDT_PORT_INPUT;  }
#line 1438 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;

  case 16:
#line 114 "src/mdt_file.y"
             { (yyval.yportType) = MDT_PORT_OUTPUT; }
#line 1444 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;

  case 17:
#line 115 "src/mdt_file.y"
             { (yyval.yportType) = MDT_PORT_INOUT;  }
#line 1450 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;

  case 18:
#line 116 "src/mdt_file.y"
             { (yyval.yportType) = MDT_PORT_INTERN; }
#line 1456 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1465 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1474 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1483 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1492 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1501 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1510 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1520 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 170 "src/mdt_file.y"
                    { (yyval.ynames) = new MdtNames;
                      ...
                      (yyval.ynames)->next = NULL;                                   }
#line 1530 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 175 "src/mdt_file.y"
                    { (yyval.ynames) = new MdtNames;
                      ...
                      (yyval.ynames)->next = NULL;                                   }
#line 1539 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 179 "src/mdt_file.y"
                    { (yyval.ynames) = new MdtNames;
                      ...
                      (yyval.ynames)->head = (yyval.ynames);
                      (yyval.ynames)->next = NULL;                                   }
#line 1548 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1561 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;
...
#line 1573 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
    break;


#line 1577 "lib/opt/lex_n_yacc/mdt_file.tab.cpp"
